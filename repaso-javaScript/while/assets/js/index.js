// -------------------------------------------------------------------------------------------------
console.log("-----------------------Ejemplo básico de un bucle while--------------------------");

// Declaramos una variable llamada 'i' y la inicializamos en 0
let i = 0;

// Usamos un bucle while para repetir un bloque de código mientras la condición (i < 5) sea verdadera
while (i < 5) {
...
// -------------------------------------------------------------------------------------------------
console.log("---------------Ejemplo de un bucle while que recorre un array-----------------");
...
// Usamos un bucle while para recorrer todos los elementos del array
// El bucle se ejecutará mientras 'j' sea menor que la longitud del array 'frutas'
...
// -------------------------------------------------------------------------------------------------
console.log("--------------Ejemplo de un bucle while con una condición compleja------------------");

// Declaramos una variable llamada 'num' y la inicializamos con un valor de 1
let num = 1;

// Usamos un bucle while para repetir un bloque de código mientras la condición (num <= 100) sea verdadera
...
// -------------------------------------------------------------------------------------------------
console.log("--------------Ejemplo de un bucle while que usa la palabra clave 'break'--------------");

// Declaramos una variable llamada 'k' y la inicializamos en 0
let k = 0;

// Usamos un bucle while para repetir un bloque de código mientras la condición (k < 10) sea verdadera
while (k < 10) {
...
// -------------------------------------------------------------------------------------------------
console.log("---------------Ejemplo de un bucle while que usa la palabra clave 'continue'---------------");

// Declaramos una variable llamada 'm' y la inicializamos en 0
let m = 0;

// Usamos un bucle while para repetir un bloque de código mientras la condición (m < 10) sea verdadera
while (m < 10) {
